...
let userNumbers = []; // Array to store user inputs
let hashTable = []; // The hash table
...
document.getElementById('separateChainingAddBtn').addEventListener('click', function () {
    ...
    const separateChainingInputWrapper = document.getElementsByClassName('separateChainingInputWrapper')[0];
...
function displayHashTable(size) {
